...
<img src="assets/viewer-pool.png" alt="Pool 视图 — 跨 session 自动捕获的思维碎片" style="border: 1px solid #d1d5db; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.12);" />

**攒够了，慢慢长成完整的思路：**

<img src="assets/viewer-thoughts.png" alt="Thoughts 视图 — 结构化的思路文档" style="border: 1px solid #d1d5db; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.12);" />
